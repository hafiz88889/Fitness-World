...
class CommunityPageNine extends StatelessWidget {
  const CommunityPageNine({super.key});
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text("Marcus Aurelius",style: regularTextStyle24,),
                    Text("Community User   97% Healthy",style: regularTextStyle18.copyWith(color: MyColor.grayColor,fontSize: 14),),
                  ],
                ),
              ),
              Container(
          ...
          child: SingleChildScrollView(
            child: Padding(
              ...
              child: Column(
                children: [
                  const SizedBox(width: 10,),
                  buildMessageItem("I'am longtime Sandow user and i love the clean and intuitive UI Thd Personalize workout plans are a game changer How are you finding it so far?", isSent: false, time: "12:30", index: 7, totalMessages: 8),
