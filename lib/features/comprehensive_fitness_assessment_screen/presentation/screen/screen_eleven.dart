      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              "Are you taking any supplements?",textAlign: TextAlign.center,
              style: regularTextStyle24.copyWith(fontSize: 30),
            ),
            const SizedBox(
              height: 30,
            ),
            Image(image: AssetImage(MyImage.medicineImage)),
            const Spacer(),
            Row(
              children: [
                Expanded(
                  child: SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                       //Navigator.pushNamed(context, RouteHelper.screenTwelve);
                      },
                      style: ButtonStyle(
                          backgroundColor:
