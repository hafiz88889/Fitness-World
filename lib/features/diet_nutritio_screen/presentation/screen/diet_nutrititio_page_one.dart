...
class DietNutritititioPageOne extends StatelessWidget {
  const DietNutritititioPageOne({super.key});
              ...
              Padding(
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Navigator.pushNamed(context, RouteHelper.nutritionDietPageTwo);
                    },
                    style: ButtonStyle(
                        backgroundColor:
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        SvgPicture.asset(
                          MyImage.rightArrowIcon,colorFilter: ColorFilter.mode(MyColor.blackColor, BlendMode.srcIn),
                        )
                      ],
                    ),
                  ),
