    ...
    return Scaffold(
      ...
      body:Column(
            ...
            Container(
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        return Container(
                          ...
                          child: Row(
                            children: [
                              SvgPicture.asset(item[index]["image"],colorFilter: ColorFilter.mode(MyColor.whiteColor, BlendMode.srcIn),height: 18,width: 18,),
                              const SizedBox(width: 8,),
                              Text(item[index]["text"],style: regularTextStyle24.copyWith(fontSize: 16,color: MyColor.whiteColor),)
                            ],
                          ),
                        );
                      },
              ...
              GestureDetector(
                  onTap: (){
                    Navigator.pushNamed(context, RouteHelper.searchPageTwo);
                  },
                  child: Text("Loading...",style: regularTextStyle24,))
            ],
      ),
    );
  }
