        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                SocialMediaWidget(image: MyImage.facebookIcon),
                SocialMediaWidget(image: MyImage.instraIcon),
                SocialMediaWidget(image: MyImage.linkDinIcon),
              ],
            ),
            const SizedBox(
              height: 40,
            ...
            Center(
              child: InkWell(
                onTap: (){
                  Navigator.pushNamed(context, RouteHelper.signUpPage);
                },
                child: RichText(
                    text: TextSpan(
