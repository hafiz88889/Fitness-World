...
class VirtualFitnessPageFifteen extends StatelessWidget {
  const VirtualFitnessPageFifteen({super.key});
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.pushNamed(context, RouteHelper.virtualFitnessPageTwenty);
                  },
                  child: Container(
