...
class VirtualFitnessPageSeven extends StatelessWidget {
  const VirtualFitnessPageSeven({super.key});
              ...
              itemBuilder: (context, index) {
                return Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: index % 2==0? MyColor.blackColor:MyColor.borderColor,
                  ),
                  child:  Text("${messageList[index]}",style: regularTextStyle18.copyWith(color: index % 2==0? MyColor.whiteColor:MyColor.blackColor,),),
                );
              },
            ),
          ),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                GestureDetector(
                  onTap: (){
                    Navigator.pushNamed(context, RouteHelper.virtualFitnessPageEleven);
                  },
                  child: Container(
                    padding: const EdgeInsets.all(15),
                    decoration: BoxDecoration(
