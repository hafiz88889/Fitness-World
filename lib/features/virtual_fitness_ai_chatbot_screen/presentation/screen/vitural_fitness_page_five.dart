...
import 'package:fitnessworld/features/virtual_fitness_ai_chatbot_screen/presentation/widget/message.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';
import 'package:percent_indicator/linear_percent_indicator.dart';

class VirtualFitnessPageFive extends StatelessWidget {
  const VirtualFitnessPageFive({super.key});
      ...
      body: Stack(
        children: [
          ShaderMask(
              ...
              child: Image(
                image: AssetImage(MyImage.robotImageThree),
